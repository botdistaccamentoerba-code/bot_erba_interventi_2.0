...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Gestione tipologia - VERSIONE MIGLIORATA
    elif data.startswith("tip_") or data.startswith("tipopage_") or data == "tipologia_altro":
        fase = context.user_data.get('fase')
        fase_modifica = context.user_data.get('fase_modifica')
        
        print(f"DEBUG HANDLER: Callback={data}, Fase={fase}, FaseModifica={fase_modifica}")  # Debug
        ...
        if fase == 'tipologia_intervento':
            ...
            # Se non siamo in un flusso riconosciuto, prova il flusso nuovo intervento
            print("DEBUG HANDLER: Flusso non riconosciuto, provo nuovo intervento")
            await gestisci_tipologia_intervento(update, context, data)
