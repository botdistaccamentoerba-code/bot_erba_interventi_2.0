...
async def gestisci_via(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # FIX CRITICO: Invece di impostare la fase, chiama direttamente la funzione successiva
    await mostra_tipologie_intervento(update.message, context)

async def mostra_tipologie_intervento(message, context):
    """Mostra direttamente la tastiera delle tipologie"""
    # Crea tastiera per le tipologie
    keyboard = []
